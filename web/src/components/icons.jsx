...
const ToggleLeft = ({ width = 24, height = 24, color = "currentColor", ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
      ...
      {...props}
    >
      <rect width="22" height="14" x="1" y="5" rx="7" />
      <circle cx="8" cy="12" r="3" />
    </svg>
  );
};

const ToggleRight = ({ width = 24, height = 24, color = "currentColor", ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
const Download = ({ width = 24, height = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={width}
    height={height}
...
const ArrowUpRight = ({ width = 24, height = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={width}
    height={height}
...
const SquarePlus = ({ width = 24, height = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={width}
    height={height}
