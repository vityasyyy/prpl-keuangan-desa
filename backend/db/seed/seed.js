...
async function seedDatabase() {
  ...
  try {
    ...
    await client.query('ALTER SEQUENCE refresh_tokens_refresh_token_id_seq RESTART WITH 1');
    ...
    console.log('Seeding rab...');
    await client.query(`
    INSERT INTO rab (id,rincian_id, mulai, selesai, kode_fungsi_id,kode_ekonomi_id, total_amount, status_rab) VALUES
    ('rab001','rin004', '2024-01-15', '2024-03-15', '2.3.10','5.3.5', 75000000.00, 'disetujui'),
    ('rab002','rin005', '2024-02-01', '2024-02-28', '2.4.11','5.3.7', 25000000.00, 'diajukan'),
    ('rab003','rin006', '2024-03-01', '2024-03-20', '4.7.04','5.2', 15000000.00, 'disetujui'),
    ('rab004','rin007', '2024-04-01', '2024-05-31', '1.2.03','5.3.4', 50000000.00, 'belum diajukan')
    `);
