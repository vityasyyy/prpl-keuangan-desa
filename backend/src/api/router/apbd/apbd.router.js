...
function augmentReqLogger(req, res, next) {
  if (req.log) {
    req.log.logError = (err, message, fields = {}) => logError(err, message, fields, req.log);
  }
  next();
}
...
export default function createApbdRouter(apbdHandler) {
  ...
  r.get("/uraian", apbdHandler.getUraian);  // GET /api/apbd/uraian
  ...
  r.get("/draft/penjabaran/:rincian_id", apbdHandler.getDraftPenjabaranApbdesById);  // GET /api/apbd/draft/penjabaran/:rincian_id
  r.get("/draft/penjabaran/summary", apbdHandler.getDraftPenjabaranApbdesSummary);  // GET /api/apbd/draft/penjabaran/summary
  ...
  r.post("/draft/penjabaran/:id/penjabaran", apbdHandler.createApbdesRincianPenjabaran);  // POST /api/apbd/draft/penjabaran/:id/penjabaran
  r.post("/draft/penjabaran/:id/penjabaran/post", apbdHandler.postDraftPenjabaranApbdes);  // POST /api/apbd/draft/penjabaran/:id/penjabaran/post
